...
<html>
    ...
    <div class="animate__animated animate__backInDown" style="position: absolute; left: 50%; top: 15%">
        <div class="container" style="width: max-content;height: max-content; top: 50px">
